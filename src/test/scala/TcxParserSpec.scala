...
class TcxParserSpec extends FlatSpec with Matchers {
  ...
  val expectedResultsminimalTcx = List(
    ...
    TrackPoint(52.50828489661217,13.210050472989678,36.599998474121094,1348463555),
    TrackPoint(52.50811725854874,13.210010407492518,36.599998474121094,1348463562)
  )
  ...
  "A parsed minimal tcx file with three Trackpoint elements" should "contain three TrackPoint objects" in {
    ...
    trackPoints.length should be(3)
  }
